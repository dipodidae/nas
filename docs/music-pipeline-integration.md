...
_Generated by `scripts/gen_pipeline_tables.py` from `cron/crontab`. 36 scheduled jobs._
...
**`--ok-codes`.** 6 of 36 jobs declare it explicitly; 30 inherit the `0,1` default, which swallows exit 1.
