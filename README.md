...
| Every `swag=enable` service has a proxy-conf                                               | The label is what publishes a subdomain — without a matching conf it publishes nothing, silently. `lingarr` served SWAG's default page for months and still answered `200`                                           | [0020](docs/decisions/0020-watchtower-replaced-and-demoted.md)                                                     |
